...
const QuoteForm = () => {
  return (
    ...
    <div className="relative group max-w-md w-full mx-auto mt-6">
      ...
      <div className="relative bg-white/90 backdrop-blur-xl border border-white rounded-[20px] p-6 shadow-[0_20px_50px_rgba(0,0,0,0.05)] overflow-hidden">
        ...
        <form className="relative z-10 space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="pt-2 space-y-4">
            <button 
              type="submit" 
              className="group/btn relative w-full py-5 bg-gray-900 rounded-2xl overflow-hidden transition-all duration-300 active:scale-95"
            >
              <div className="absolute inset-0 bg-[#b0008e] translate-y-full group-hover/btn:translate-y-0 transition-transform duration-300"></div>
            ...
            >
              ...
              <span className="tracking-tight text-sm">Call Now: 90147 04373</span>
            </a>
          </div>
        </form>
      </div>
