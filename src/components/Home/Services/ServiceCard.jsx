...
const ServiceCard = ({ title, image, desc }) => (
  <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(176,0,142,0.2)] group">
    {/* Image Container */}
    <div className="h-56 overflow-hidden relative">
      ...
      <div className="absolute inset-0 bg-linear-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
        <span className="text-white font-bold">VRS Reliable Service</span>
      </div>
    </div>

    {/* Content */}
    <div className="p-6 text-center">
      <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#b0008e] transition-colors">
        {title}
      </h3>
